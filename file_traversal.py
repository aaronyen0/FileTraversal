...
class FileTraversal:
    ...
    def __init__(self):
        ...
        self.detail_folder_format = '+- <{folder_name}> [CNT = {file_cnt}, SIZE = {file_size} KB]'
        self.detail_file_format = '+- {file_name} [SIZE = {file_size}]'
    ...
    def sorted_listdir(self, node_name: str):
        """
        sort the current path, and put files in fornt of folders
        """
